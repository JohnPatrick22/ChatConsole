...
//        Console.log('onProgress', event, parseInt((event.loaded / event.total * 100)) + '%');
//    }
//
//    
//    this.uploadFile = function(_file, to, _source, onSuccess) {      
//    // function upload(files, onSuccess, onError, onProgress) {
//        console.log('SendRequest', type, to);
//        
//        var files = [_file];
//
//        var fd = new FormData();
...
//    
    ...
    function sendRequest(_type, _pathname, _paramtext, _url, _callbackError) {
        ...
        Console.log( "HTTPCommunication - sendRequest - lvUrl [" + lvUrl + "]");
